# 【BrushUp】我写了一个 LeetCode 刷题自动追踪工具，从此告别手动打卡
...
作为一个程序员，这种事情肯定不能忍。于是我花了点时间搞了一个工具 —— **BrushUp**，自动从 LeetCode 拉取 AC 记录，自动更新进度表，自动计算复习计划，甚至还有炫彩终端面板和 Web 看板。
...
> 项目地址：[github.com/HuangJingwang/brushup](https://github.com/HuangJingwang/brushup)
